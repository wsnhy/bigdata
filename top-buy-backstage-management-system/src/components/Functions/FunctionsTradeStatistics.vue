<template>
    <div class="w-FunctionsTradeStatistics-content">
        <h1 class="w-TradeStatistics-title">商品交易量统计</h1>
        <div id="w-TradeStatistics-charsBox"></div>
    </div>
</template>
...
<script>
    ...
    import "echarts";
    export default {
        name: "FunctionsTradeStatistics",
        mounted(){
            var dom = document.getElementById("w-TradeStatistics-charsBox");
...
<style scoped>
    .w-FunctionsTradeStatistics-content{
        width: 100%;
        height: 100%;
        box-sizing: border-box;
        padding: 30px;
    }
    .w-TradeStatistics-title {
        width: 17%;
        color: #d1bebe;
        font-size: 30px;
        text-align: center;
